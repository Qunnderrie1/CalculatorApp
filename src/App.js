    ...
    <div className="App flex justify-center bg-black
     h-[100vh]">
      <div className='flex flex-col gap-4 justify-center '>
        <h1 className='text-white text-center text-4xl mb-10 font-semibold'>Calculator </h1>
        ...
        <footer>
          <p className='text-white text-center mt-10'> &copy; 2025 Designed & Developed by Qunnderrie</p>
        </footer>
      </div>
